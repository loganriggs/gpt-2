## Getting started
In order to start generating samples,
...
![Parameters](images/generateSamplesParameters.png)
* Change "model_name" to the one you downloaded
* Read the comments for further details, but of interest is the number of generated tokens (length), the number of considered tokens (top_k), and top N tokens by probability (softmax_length)
